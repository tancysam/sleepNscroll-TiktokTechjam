...
def main() -> int:
    ...
    print("  counts every attempt, including the 11 that errored before returning usage, so it")
    print("  reports 114 where this reports", total["calls"], "on identical token totals.")
