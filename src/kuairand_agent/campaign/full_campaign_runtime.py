    ...
    records = [
        *prior_records,
        _iteration_record(
            ...
            # The first iteration ran on runtime_template itself, so its fusion records are here.
            # Later iterations each get a fresh records dict from the replace() below.
